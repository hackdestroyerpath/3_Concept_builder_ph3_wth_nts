...
Этот файл описывает минимальный шаблон concrete concept. Он не является рабочей концепцией и не должен получать issue, output или export до создания реального concept scope. Шаблон задаёт форму будущей сети файлов.
